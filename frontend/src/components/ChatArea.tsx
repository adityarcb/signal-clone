    ...
    return (
      <div className="flex h-full items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-500">Select a conversation to start messaging</p>
        </div>
      </div>
    );
  }
    ...
    <div className="flex h-full flex-col bg-gray-50">
      <div className="flex items-center gap-3 border-b border-gray-200 bg-white px-4 py-3">
        ...
        <div className="flex-1">
          <h2 className="font-medium text-gray-900">{getConversationName(activeConversation)}</h2>
      ...
      <form onSubmit={handleSendMessage} className="border-t border-gray-200 bg-white px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="flex-1 rounded-full bg-gray-100 px-4 py-2 text-sm placeholder-gray-500 focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
